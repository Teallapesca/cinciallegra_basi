    ...
    <div class="principale">
            <?php
                ...
                if (isset($_GET['titolo'])) {//eseguirò tutto questo codice se non c'è stato alcun probelma di settaggio del test scelto
                    ...
                    $concluso=visualizzaRisposte($titoloTest, $conn);//faccio il controllo se il visualizza risposte del test è settato a 1 o a 0
        ...
        <form name="test" method="GET" action="SvolgiTest.php?titolo=<?php $_SESSION['titoloTest'] ?>">
            <?php
                    ...
                    foreach($_SESSION["quesiti$titoloTest"] as $key => $quesito){
                        ...
                        $chiuso_query = "SELECT * FROM quesito_chiuso as c, opzione as o WHERE c.Progressivo=o.ProgressivoChiuso AND c.TitoloTest=o.TitoloTest AND c.Progressivo='$progressivo' AND c.TitoloTest='$titoloTest'";
